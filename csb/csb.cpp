       ...
       if (debug)
         result +=
           std::format("  const loader mounted{{\"CSGame.csp\", {}ull, {}, {}, {}, {}, {}, {}}};\n",
                       container.signature(), container.table[frames_entry].first, container.table[frames_entry].second,
                       container.table[hitboxes_entry].first, container.table[hitboxes_entry].second,
                       container.table[strings_entry].first, container.table[strings_entry].second);
       else
         result +=
           std::format("  const loader mounted{{\"CSGame.csp\", {}ull, {}, {}, {}, {}}};\n", container.signature(),
